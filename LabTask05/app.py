...
if algo == "Kmeans":
    ...
    eps = st.sidebar.slider("Maximum Distance (eps)", 0.1, 2.0, 0.5, 0.1)
...
if algo == "DBSCAN":
    ...
    cluster_col, noise_col = st.columns(2)
    cluster_col.metric("Number of Clusters", n_clusters_found)
    noise_col.metric("Noise Points", n_noise_points)
else:
